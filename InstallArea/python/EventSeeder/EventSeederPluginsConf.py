#Thu Feb 22 20:14:51 2024"""Automatically generated. DO NOT EDIT please"""
import sys
...
class MarlinEvtSeeder( ConfigurableService ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
  ...
  _propertyDocDct = { 
    ...
    'RandomSeed' : """  [MarlinEvtSeeder] """,
  }
  __declaration_location__ = 'MarlinEvtSeeder.cpp:9'
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(MarlinEvtSeeder, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'EventSeederPlugins'
  def getType( self ):
      return 'MarlinEvtSeeder'
  pass # class MarlinEvtSeeder
