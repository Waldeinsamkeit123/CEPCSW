#Mon Feb 26 15:41:44 2024"""Automatically generated. DO NOT EDIT please"""
import sys
...
class DumpMCParticleAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    'ExtraInputs' : [], # list
    'ExtraOutputs' : [], # list
    'OutputLevel' : 0, # int
  ...
  _propertyDocDct = { 
    ...
    'Field' : """  [DumpMCParticleAlg] """,
    'MCParticleCollection' : """ Handle of the Input MCParticle collection [unknown owner type] """,
  }
  __declaration_location__ = 'DumpMCParticleAlg.cpp:16'
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(DumpMCParticleAlg, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'DumpEvent'
  def getType( self ):
      return 'DumpMCParticleAlg'
  pass # class DumpMCParticleAlg

class DumpSimHitAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    'ExtraInputs' : [], # list
    'ExtraOutputs' : [], # list
    'OutputLevel' : 0, # int
  ...
  __declaration_location__ = 'DumpSimHitAlg.cpp:40'
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(DumpSimHitAlg, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'DumpEvent'
  def getType( self ):
      return 'DumpSimHitAlg'
  pass # class DumpSimHitAlg

class DumpTrackAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    'ExtraInputs' : [], # list
    'ExtraOutputs' : [], # list
    'OutputLevel' : 0, # int
    ...
    'Field' : 3.0000000, # float
    'MCParticleCollection' : DataHandle('MCParticle', 'R', 'DataWrapper<edm4hep::MCParticleCollection>'), # DataHandle
    'TrackCollection' : DataHandle('SiTracks', 'R', 'DataWrapper<edm4hep::TrackCollection>'), # DataHandle
  }
  _propertyDocDct = { 
    'ExtraInputs' : """  [DataHandleHolderBase<PropertyHolder<CommonMessaging<implements<IAlgorithm,IDataHandleHolder,IProperty,IStateful> > > >] """,
    'ExtraOutputs' : """  [DataHandleHolderBase<PropertyHolder<CommonMessaging<implements<IAlgorithm,IDataHandleHolder,IProperty,IStateful> > > >] """,
    ...
    'Field' : """  [DumpTrackAlg] """,
    'MCParticleCollection' : """ Handle of the Input MCParticle collection [unknown owner type] """,
    'TrackCollection' : """ Handle of the Input Track collection from CEPCSW [unknown owner type] """,
  }
  __declaration_location__ = 'DumpTrackAlg.cpp:26'
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(DumpTrackAlg, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'DumpEvent'
