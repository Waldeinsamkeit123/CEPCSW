...
class PandoraPFAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    ...
    'ECalReadOutNames' : [ 'EcalBarrelCollection' , 'EcalEndcapsCollection' , 'ECALOther' ], # list
    'HCalCaloHitCollections' : [ 'HCALBarrel' , 'HCALEndcap' , 'HCALOther' ], # list
    'HCalReadOutNames' : [ 'HcalBarrelCollection' , 'HcalEndcapsCollection' , 'HCALOther' ], # list
    'LCalCaloHitCollections' : [ 'LCAL' ], # list
    'LCalReadOutNames' : [ 'LcalBarrelCollection' ], # list
    'LHCalCaloHitCollections' : [ 'LHCAL' ], # list
    'LHCalReadOutNames' : [ 'LHcalBarrelCollection' ], # list
    'MuonCaloHitCollections' : [ 'MUON' ], # list
    'MuonCalReadOutNames' : [ 'MuonCollection' ], # list
    ...
    'debug' : False, # bool
    'WriteAna' : False, # bool
    'use_dd4hep_geo' : False, # bool
    'use_dd4hep_decoder' : True, # bool
    'use_preshower' : False, # bool
    'collections' : [  ], # list
    ...
    'WriteMCRecoParticleAssociation' : DataHandle('pfoMCRecoParticleAssociation', 'W', 'DataWrapper<edm4hep::MCRecoParticleAssociationCollection>'), # DataHandle
  }
  _propertyDocDct = { 
    ...
    'ECalReadOutNames' : """  [PandoraPFAlg] """,
    'HCalCaloHitCollections' : """  [PandoraPFAlg] """,
    'HCalReadOutNames' : """  [PandoraPFAlg] """,
    'LCalCaloHitCollections' : """  [PandoraPFAlg] """,
    'LCalReadOutNames' : """  [PandoraPFAlg] """,
    'LHCalCaloHitCollections' : """  [PandoraPFAlg] """,
    'LHCalReadOutNames' : """  [PandoraPFAlg] """,
    'MuonCaloHitCollections' : """  [PandoraPFAlg] """,
    'MuonCalReadOutNames' : """  [PandoraPFAlg] """,
    ...
    'max_mc' : """  [PandoraPFAlg] """,
    'max_rec' : """  [PandoraPFAlg] """,
    'debug' : """ if do debug [PandoraPFAlg] """,
    'WriteAna' : """ if do ana [PandoraPFAlg] """,
    'use_dd4hep_geo' : """ choose if use geo info from dd4hep [PandoraPFAlg] """,
    'use_dd4hep_decoder' : """ if use decoder from dd4hep [PandoraPFAlg] """,
    'use_preshower' : """ if use preshower layer for calorimeter [PandoraPFAlg] """,
    ...
    'WriteMCRecoParticleAssociation' : """ Handle of the MCRecoParticleAssociation       output collection [unknown owner type] """,
  }
  __declaration_location__ = 'PandoraPFAlg.cpp:19'
