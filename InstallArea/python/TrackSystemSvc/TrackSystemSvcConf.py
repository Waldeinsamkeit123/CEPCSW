#Thu Feb 22 20:15:59 2024"""Automatically generated. DO NOT EDIT please"""
import sys
...
class TrackSystemSvc( ConfigurableService ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
  ...
  __declaration_location__ = 'TrackSystemSvc.cpp:8'
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(TrackSystemSvc, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'TrackSystemSvc'
  def getType( self ):
      return 'TrackSystemSvc'
  pass # class TrackSystemSvc
