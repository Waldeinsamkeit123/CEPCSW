...
class SimHitMergeAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    'ExtraInputs' : [], # list
    'ExtraOutputs' : [], # list
    'OutputLevel' : 0, # int
    ...
    'VetoObjects' : [  ], # list
    'RequireObjects' : [  ], # list
    'InputCollections' : [ 'EcalBarrelSiliconCollection' , 'EcalEndcapSiliconCollection' , 'EcalEndcapRingCollection' ], # list
    'OutputCollections' : [ 'ECALBarrel' , 'ECALEndcap' , 'ECALOther' ], # list
    'sanity_check' : False, # bool
    'cell_x' : 10.0000, # float
    'cell_y' : 10.0000, # float
    'cell_z' : 10.0000, # float
  }
  _propertyDocDct = { 
    ...
    'InputCollections' : """ Input Hit collection Names [SimHitMergeAlg] """,
    'OutputCollections' : """ Name of merged Hit Collections [SimHitMergeAlg] """,
    'sanity_check' : """ sanity check [SimHitMergeAlg] """,
    'cell_x' : """  [SimHitMergeAlg] """,
    'cell_y' : """  [SimHitMergeAlg] """,
    'cell_z' : """  [SimHitMergeAlg] """,
  }
  __declaration_location__ = 'SimHitMergeAlg.cpp:19'
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(SimHitMergeAlg, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'SimHitMerge'
  def getType( self ):
      return 'SimHitMergeAlg'
  pass # class SimHitMergeAlg
