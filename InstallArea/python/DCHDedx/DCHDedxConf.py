#Thu Feb 22 20:15:18 2024"""Automatically generated. DO NOT EDIT please"""
import sys
...
class RecDCHDedxAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    'ExtraInputs' : [], # list
    'ExtraOutputs' : [], # list
    'OutputLevel' : 0, # int
    ...
    'debug' : 0, # int
    'method' : 1, # int
    'truncate' : 0.700000, # float
    'WriteAna' : False, # bool
    'dedx_scale' : 1.00000, # float
    'dedx_resolution' : 0.00000, # float
  ...
  _propertyDocDct = { 
    ...
    'sampling_option' : """  [RecDCHDedxAlg] """,
    'debug' : """  [RecDCHDedxAlg] """,
    'method' : """  [RecDCHDedxAlg] """,
    'truncate' : """  [RecDCHDedxAlg] """,
    'WriteAna' : """  [RecDCHDedxAlg] """,
    'dedx_scale' : """  [RecDCHDedxAlg] """,
    'dedx_resolution' : """  [RecDCHDedxAlg] """,
    'DCHitAssociationCollection' : """ Handle of association collection [unknown owner type] """,
    'DCTrackCollection' : """ Handle of input Track collection [unknown owner type] """,
  }
  __declaration_location__ = 'RecDCHDedxAlg.cpp:22'
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(RecDCHDedxAlg, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'DCHDedx'
  def getType( self ):
      return 'RecDCHDedxAlg'
  pass # class RecDCHDedxAlg
