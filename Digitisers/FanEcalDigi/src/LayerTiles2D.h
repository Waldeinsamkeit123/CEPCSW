#ifndef LayerTiles2D_h
#define LayerTiles2D_h
...
class LayerTiles {
  ...
  public:
    ...
    std::array<int,2> searchBox(float xMin, float xMax){
      int xBinMin = xMin;
      int xBinMax = xMax;
//      cout<<"Xbin min: "<<xBinMin<<" ; max: "<<xBinMax<<endl;
      return std::array<int, 2>({{ xBinMin,xBinMax }});
    }
